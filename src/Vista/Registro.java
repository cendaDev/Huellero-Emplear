...
public class Registro extends javax.swing.JFrame {
    ...
    public Funcionario encontrarFuncionarioPorHuella(DPFPFeatureSet huella, String huellabytes) {
        ...
        if (connection != null) {
            ...
            try {
                // Modifica la consulta para obtener información sobre el cargo
                String query = "SELECT f.*, c.nombre AS nombre_cargo, t.`dias`, t.hora_ingreso, t.hora_salida "
                        + "FROM funcionarios f "
                    ...
                    if (templateBuffer != null && templateBuffer.length > 0) {
                        ...
                        if (result.isVerified() && result.getFalseAcceptRate() < 0.001) {
                            ...
                            if (distancia < menorDistancia) {
                                ...
                                // Obtener información sobre el cargo
                                String nombreCargo = resultSet.getString("nombre_cargo");
                                ArrayList<Turno> turnos = controlador.obtenerTurnosDesdeResultSet(resultSet);

                                // Crear el objeto Cargo
                                Cargo cargo = new Cargo(nombreCargo, turnos);
                ...
                // Cierre del ResultSet, PreparedStatement y conexión en bloques separados
                try {
                    if (resultSet != null) {
                        resultSet.close();
                    }
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if (funcionario != null) {
            ...
            JOptionPane.showMessageDialog(null, "El funcionario no se encuentra registrado, debes registrarlo en la página de recursos humanos de EMPLEAR");
        }
